...
parser.add_argument('--dataset_name', type=str, default="GCPS", help='dataset_name')
...
if __name__ == '__main__':
    ...
    img_ids = [os.path.basename(os.path.dirname(os.path.abspath(p)))+"/"+os.path.splitext(os.path.basename(p))[0] for p in img_ids]
